<div class="carousel carousel-slider" data-indicators="true" >
    ...
    <div class="carousel-fixed-item center">
    	...
    	<p class="white-text">
    		Hi There, I'm Shrikant Pradhan <br/>
...
<div class="fixed-action-btn">
    ...
    <ul>
      ...
      <li ><a class="btn-floating green tooltipped" data-position="left" data-delay="50" data-tooltip="Download My Resume"><i class="material-icons">file_download</i></a></li>
      <li ><a class="btn-floating blue back-to-top tooltipped" id="back-to-top"  data-position="left" data-delay="50" data-tooltip="Go To Top"><i class="material-icons">expand_less</i></a></li>
    </ul>
  </div>